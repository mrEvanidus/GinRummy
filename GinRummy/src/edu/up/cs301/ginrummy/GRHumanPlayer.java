...
public class GRHumanPlayer extends GameHumanPlayer implements Animator {
	...
	RelativeLayout rulesBox;
	
	// the buttons
	Button exitButton, rulesButton, nextPageButton;

	// the score and message pane text fields
	private TextView oppScore, myScore, messagePane, gameRules; 
	...
	public void setAsGui(GameMainActivity activity) {
		...
		rulesBox = (RelativeLayout) activity.findViewById(R.id.gameRulesContainer);
		
		// initialize the buttons
		exitButton = (Button) activity.findViewById(R.id.exitButton);
		rulesButton = (Button) activity.findViewById(R.id.rulesButton);
		nextPageButton = (Button) activity.findViewById(R.id.rulesNextPage);
		...
		gameRules = (TextView) activity.findViewById(R.id.gameRules);
		...
		//set up  gameRule button listener
		rulesButton.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				//toggle visibility
				if (rulesBox.getVisibility() == View.INVISIBLE) {
					rulesBox.setVisibility(View.VISIBLE);
					rulesButton.setText("Return to Game");
				}
				else {
					rulesButton.setText("How to Play");
					rulesBox.setVisibility(View.INVISIBLE);
				}
			}
		});
		
		//set up next rule page button listener
		nextPageButton.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				//cycle through the pages of rules
				if (gameRules.getText().equals(myActivity.getString(R.string.gameRules01))) {
					gameRules.setText(R.string.gameRules02);
				}
				else if (gameRules.getText().equals(myActivity.getString(R.string.gameRules02))){
					gameRules.setText(R.string.gameRules03);
				}
				else if (gameRules.getText().equals(myActivity.getString(R.string.gameRules03))){
					gameRules.setText(R.string.gameRules04);
				}
				else {
					gameRules.setText(R.string.gameRules01);
				}
			}
